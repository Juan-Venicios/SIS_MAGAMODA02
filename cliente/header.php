...
<?php
		include_once('conect/conect.php');
      	...
      	$select = "SELECT * FROM tb_cliente WHERE email_cliente=:emailUser AND senha_cliente=:senhaUser  AND status_cliente=:status";
        ...
        if ($contar > 0) {
          while ($show = $resultado->FETCH(PDO::FETCH_OBJ)) {
            ...
            $status_cliente = $show->status_cliente;      
          }
        } else {
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <h5 class="centered"><a href="home.php?acao=perfil&upperfil=<?php echo $id_cliente; ?>"> <?php echo $nome_cliente;?> </a></h5>
                          ...
                          <li class="sub-menu">
                              <span><a href="home.php?acao=pedidoTAB"> <i class="fa fa-users"></i>Pedidos</a></span>        
                          </li>
        </ul>
      </div>
    </aside>
